...
import com.example.xu.coolweather.gson.Forecast;
import com.example.xu.coolweather.gson.Weather;
import com.example.xu.coolweather.service.AutoUpdate;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private ImageView img_everyday;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comforText=(TextView)findViewById(R.id.comfort);
        carWashText=(TextView)findViewById(R.id.car_wash_text);
        sportText=(TextView)findViewById(R.id.sport_text);
        img_everyday=(ImageView)findViewById(R.id.img);
        ...
        if(bingPic!=null)
        {
            Glide.with(this).load(bingPic).into(img_everyday);
        }
        else {
            loadpic();
        }
        ...
        HttpUtil.SendOkHttpRequest(requestpic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(bingpic).into(img_everyday);
                    }
                });
            }
        });
